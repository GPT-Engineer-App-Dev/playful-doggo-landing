    ...
    <div className="space-y-10">
      ...
      <section className="text-center space-y-4">
        <div className="relative">
          <img src="/placeholder.svg" alt="Dogs" className="w-full h-64 object-cover" />
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          {Array.from({ length: 6 }).map((_, index) => (
            <Card key={index}>
              <CardHeader>
                <img src="/placeholder.svg" alt={`Breed ${index + 1}`} className="w-full h-32 object-cover" />
              </CardHeader>
              <CardContent>
        ...
        <ul className="space-y-2">
          {Array.from({ length: 5 }).map((_, index) => (
            <li key={index} className="flex items-start space-x-2">
              <img src="/placeholder.svg" alt={`Tip ${index + 1}`} className="w-8 h-8 object-cover" />
